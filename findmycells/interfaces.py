...
# %% auto 0
__all__ = ['GUI_SPACER', 'API', 'PageButtonBundle', 'SettingsPage', 'ProcessingStepPage', 'InspectionPage', 'GUI']
...
# %% ../nbs/api/03_interfaces.ipynb 9
GUI_SPACER = w.Label(value = '', layout = {'height': '30px'})

# %% ../nbs/api/03_interfaces.ipynb 11
...
# %% ../nbs/api/03_interfaces.ipynb 12
...
# %% ../nbs/api/03_interfaces.ipynb 13
...
# %% ../nbs/api/03_interfaces.ipynb 14
...
# %% ../nbs/api/03_interfaces.ipynb 15
class GUI:
