...
# %% auto 0
__all__ = ['MAIN_SUBDIR_ATTRIBUTES', 'SEGMENTATION_TOOL_SUBDIR_ATTRIBUTES', 'INSPECTION_SUBDIR_ATTRIBUTES', 'RENAMING_DICT',
           'listdir_nohidden', 'Database']

# %% ../nbs/01_database.ipynb 3
